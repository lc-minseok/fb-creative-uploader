...
// Meta 로고 SVG (직접 그림)
const META_LOGO_SVG = `<svg width="36" height="22" viewBox="0 0 36 22" xmlns="http://www.w3.org/2000/svg">
  <path fill="white" d="
    M4 11
    C4 7.5 5.8 4.5 8.5 4.5
    C10.5 4.5 12 5.8 13.8 8.5
    L18 15
    L22.2 8.5
    C24 5.8 25.5 4.5 27.5 4.5
    C30.2 4.5 32 7.5 32 11
    C32 14.5 30.2 17.5 27.5 17.5
    C25.5 17.5 24 16.2 22.2 13.5
    L18 7
    L13.8 13.5
    C12 16.2 10.5 17.5 8.5 17.5
    C5.8 17.5 4 14.5 4 11Z
